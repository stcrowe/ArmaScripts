...
fnTFA_startbodycam =
{
	...
	_programWindow = [1,1,30,15, _fileName] call fnTFA_DrawWindow;
	...
	[_programWindow select 0, _direction, [11,0,4,1]] call fnTFA_addControlToWindow;

	_playerSelection = ["RscCombo", "", 0,0,0,0] call addCtrl;
	[_programWindow select 0, _playerSelection, [0,0,10,1]] call fnTFA_addControlToWindow;
