...
fnTFA_startsurveilence =
{
	missionNamespace setVariable [format["%1%2", _processId, "cam"], nil];
	_width = 30;
	_height = 20;
	_programWindow = [1, 1, _width, _height, _fileName] call fnTFA_DrawWindow;
	_renderSurface = ["RscPicture", "", 0,0,0,0] call addCtrl;
	[_programWindow select 0, _renderSurface, [0,0,_width,_height - 1.5]] call fnTFA_addControlToWindow;

	_btnNormal = ["RscButton", "0", 0,0,0,0] call addCtrl;
	[_programWindow select 0, _btnNormal, [0,0,1,1]] call fnTFA_addControlToWindow;
	...
	[_programWindow select 0, _btnNV, [1.1,0,1,1]] call fnTFA_addControlToWindow;
	...
	[_programWindow select 0, _btnWarm, [2.2,0,1,1]] call fnTFA_addControlToWindow;
	...
	[_programWindow select 0, _btnPlus, [1.1,1.1,1,1]] call fnTFA_addControlToWindow;
	...
	[_programWindow select 0, _btnMinus, [0,1.1,1,1]] call fnTFA_addControlToWindow;
	...
	[_programWindow select 0, _playerSelection, [0,3.2,10,1]] call fnTFA_addControlToWindow;
	...
	[_programWindow select 0, _textHeight, [4.4,1.1,3,1]] call fnTFA_addControlToWindow;

	_textDirection = ["RscText", "0", 0,0,0,0] call addCtrl;
	[_programWindow select 0, _textDirection, [7.8,1.1,4,1]] call fnTFA_addControlToWindow;
