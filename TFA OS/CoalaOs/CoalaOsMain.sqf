...
coalaDefaultWebPage = "tfasubnet\index.html";
coalaDebug = true;
...
_welcomeText = format["TFA OS [Version 1.34.483]%1Copyright (c) 2015 Legion Corporation. All rights reserved. jk.%1%1%2 ", _CRLF, coala_currentFolderName];
