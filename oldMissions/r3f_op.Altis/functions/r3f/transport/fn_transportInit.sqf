...
_myactionCargo = ["R3F_cargo", STR_R3F_LOG_action_content_vehicle,"",{_this spawn AdvLog_fnc_seeCargo;},{!R3F_LOG_mutex_local_lock},{}] call ace_interact_menu_fnc_createAction;
...
if (_object isKindOf "VTOL_01_base_F") then
{
	...
	_object addAction [("<t color=""#dddd00"">" + STR_R3F_LOG_action_content_vehicle + "</t>"), {_this spawn AdvLog_fnc_seeCargo;}, nil, 4, false, true, "", "!R3F_LOG_mutex_local_lock"];
